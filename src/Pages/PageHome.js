    ...
    <>
      ...
      <section className="home-hero-section">
        <div id="home-content-wrapper">
          <h1>
            Hello! I'm Ja<span className="gold">y</span>son.
          </h1>
          <h4>
            I am a Front-end Web Developer striving to get 1% better everyday!{" "}
          </h4>
          <p>
            With backgrounds in UX design, behavioural economics and psychology,
            digital marketing, and entrepreneurship, I build complex websites
      ...
      <section className="home-about-me">
        ...
        <article>
          <p>
            I love soccer, muay thai, spikeball, oil painting, nerding out over
            history documentaries, hiking mountains and coasts, cooking, and
            salsa dancing!
          </p>
          <p>
            In my free time, you’ll probably find me cooking some new dish,
            getting lost in a good book or podcast, or reviewing my goals for
            the year.{" "}
          </p>
          <p>
            My background prior to Design and Development is in ecommerce and
            service digital marketing and running my own wedding DJ business.
          </p>
        </article>
        <div className="accordion-wrapper-main">
          <Accordion header={"Tools & Tech Stack"} data={""}>
            ...
            {techStackData &&
              techStackData.design.map((skill) => (
                <span className="pill">{skill.skill}</span>
              ))}
            {techStackData &&
              techStackData.marketing.map((skill) => (
                <span className="pill">{skill.skill}</span>
              ))}
          </Accordion>
          <Accordion header={"Passion Projects"} data={""}>
            ...
            <p>
              ...
              <a
                className="text-link"
                href="https://www.designerslack.community/community/vancouver-design-check-in"
                target="_blank"
                rel="noopener noreferrer"
              >
                Vancouver Design Check-in
              </a>{" "}
              Slack community with my friend, Marisa Chan. We just completed
              Think Again by Adam Grant and are selecting our next book!
            </p>
            <h4>Impact 2022</h4>
            <strong>
              Reflecting on 2021 and setting actionable goals for 2022.
            </strong>
            <p>
              I created a goals and reflection worksheet to help set actionable
              goals for the year and learn lessons from the past. Originally, I
              made it for myself and my friend but I ended up publishing it{" "}
              <a
                className="text-link"
                href="https://jaysonpostle.com/impact-2022"
                target="_blank"
                rel="noopener noreferrer"
              >
                here
      ...
      <section className="home-testimonial">
        <figure class="quote">
          ...
          <blockquote>
            I’ve known Jayson since March 2012. He’s worked for me as an event
            designer and marketer with notable events such as Diner en Blanc (6
            years), Bayview Gala, and Our Place Hungry Hearts. In that time, I
            know him to be a self-starter, receptive to feedback, a creative
            problem solver, and highly motivated.
          </blockquote>
          <figcaption>
      ...
      <section className="home-contact">
        ...
        <p>
          I’m always curious about new conversations and opportunities. I’m just
          as excited to talk marketing & design as I am sports, hiking, and good
          food!
        </p>
