  ...
  return (
    <>
      <section>
        <h1>Portfolio</h1>
        <h4>
          View below my mix of full-stack and front-end development projects
          using React.js, Node.js/Express.js, and/or vanilla JavaScript.
        </h4>
      </section>
      <section>
        <nav className="portfolio-filter-nav">
          <ul>
            ...
            <li>
              <span className="pill">All Development</span>
            </li>
            <li>
              <span className="pill">All Design</span>
            </li>
          </ul>
        </nav>
